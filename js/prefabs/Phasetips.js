    ...
    this.onHoverOver = function() {
        ...
        if (_options.animation === "fade") {
            _this.tweenObj = game.add.tween(_this.mainGroup).to({
                    alpha: 1
                }, _options.animationSpeedShow, Phaser.Easing.Linear.None, true, _options.animationDelay, 0,
                false);
    ...
    this.createTooltips = function() {
        ...
        if (_customBackground === false) {
            ...
            if (_roundedCornersRadius == 1) {
                ...
                tooltipBG.drawRoundedRect(0, 0, tooltipContent.width + _padding, tooltipContent.height +
                    _padding, _roundedCornersRadius);
            }
        } else {
